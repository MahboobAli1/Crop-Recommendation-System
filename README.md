...
![Live Demo](https://img.shields.io/badge/Live%20Demo-Streamlit-red)
...
- **Interactive UI:** Built with Streamlit for a seamless, user-friendly experience featuring sliders and real-time inference.
- **Crop Information Gallery:** An integrated database displaying historical averages and environmental requirements for various crops.

## 🛠️ Tech Stack
- **Language:** Python
- **Machine Learning:** Scikit-Learn (Classification Model, StandardScaler)
